...
<body class="bg-slate-50 text-slate-800 font-sans antialiased min-h-screen flex">
    ...
    <aside class="w-64 bg-slate-900 text-slate-300 flex flex-col justify-between hidden md:flex shrink-0">
        <div>
            ...
            <nav class="p-4 space-y-1">
                ...
                <!-- Jdid: Lien dyal Gestion des Utilisateurs -->
    ...
    <main class="flex-1 flex flex-col min-w-0 overflow-x-hidden">
        ...
        <div class="p-6 max-w-7xl w-full mx-auto space-y-6 flex-1">
            ...
            <!-- SECTION 1: US 4.1 - Gestion des Pertes -->
            ...
            <!-- SECTION 2: US 4.2 - /admin/reports -->
            ...
            <!-- Jdid: SECTION 3 - Gestion des Utilisateurs (Page jdidda) -->
            <div id="view-users" class="space-y-6 hidden">
                <!-- Top Header dyal l-page -->
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                    ...
                    <!-- Bouton Ajouter User (Modern & Pro) -->
                    <div>
                        <button class="inline-flex items-center gap-2 px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold rounded-xl shadow-md shadow-emerald-100 hover:shadow-emerald-200 transition-all duration-200 transform active:scale-95">
                        ...
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="divide-y divide-slate-100 text-sm">
                                ...
                                <tr class="hover:bg-slate-50/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div class="w-9 h-9 rounded-full bg-emerald-100 text-emerald-700 flex items-center justify-center font-bold text-xs">
                                                KH
                                            </div>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex items-center justify-end gap-2">
                                            ...
                                            <button class="p-2 text-slate-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors" title="Modifier">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2a2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                                </svg>
                                            </button>
                                            <!-- Action: Delete -->
                                ...
                                <tr class="hover:bg-slate-50/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <span class="font-semibold text-slate-900">Sanaa Alami</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 text-slate-600">s.alami@pharma.ma</td>
                                    <td class="px-6 py-4">
    ...
    <script>
        ...
        // Updated switch tab function to handle the new section
        function switchTab(tab) {
            ...
            // Loop and toggle views / button classes
